...
public class SensorCollectControllerTest {
	@Autowired
	...
	public void testOk() throws Exception {
		...
		ResultActions mvcResult = mockMvc.perform(post(uri).content(objectMapper.writeValueAsString(sensorDtoFactory.sensorRequest()))
